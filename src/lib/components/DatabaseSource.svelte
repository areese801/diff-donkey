<script lang="ts">
  import { loadDatabaseSource, loadFromSavedConnection, loadSnowflakeSource, getQueryHistory, deleteQueryHistoryEntry, clearQueryHistory, exportConnectionsToFile, importConnectionsFromFile } from "$lib/tauri";
